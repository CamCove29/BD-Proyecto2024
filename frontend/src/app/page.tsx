            ...
            <div className='flex gap-4 w-full p-8 flex-col md:flex-row max-w-[1920px]'>
                {!createdIndex && (
                    <div className="bg-gray-800 p-8 rounded shadow-md w-full md:w-1/2">
                        <h1 className="text-2xl font-bold mb-6 text-center">Bienvenido al Proyecto BD02 !!!</h1>
                        <form onSubmit={handleSubmit(handleCreateIndex)}>
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-300">CSV a procesar:</label>
                                <select
                                ...
                                >
                                    <option value="">Seleccion la data:</option>
                            ...
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-300">Tamaño del Bloque:</label>
                                <input
                                    type="number"
                                    className="mt-1 block w-full py-2 px-3 border border-gray-600 bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    {...register("block_size", {
                ...
                {createdIndex && (
                    <div className="bg-gray-800 p-8 rounded shadow-md w-full md:w-1/2 md:overflow-y-auto custom-scrollbar">
                        <h1 className="text-2xl font-bold mb-6 text-center">Busca tus canciones favoritas</h1>
                        <form onSubmit={handleSearchSubmit(handleSearch)}>
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-300">Consulta:</label>
                                <input
                                    type="text"
                                    className="mt-1 block w-full py-2 px-3 border border-gray-600 bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            ...
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-300">Seleccione según como quiera obtener la respuesta:</label>
                ...
                <div className="bg-gray-800 p-8 rounded shadow-md w-full md:w-1/2 md:overflow-y-auto custom-scrollbar">
                    {!createdIndex && (
                        <div className='h-full flex justify-center items-center'>
                            <h1 className="text-2xl font-bold mb-6 text-center"> Hola, empieza por crear los índices :)</h1>
                        </div>
                    )}
                    {createdIndex && (
                        <div>
                            <h1 className="text-2xl font-bold mb-6 text-center">Resultados de la búsqueda</h1>
