...
for i in data_size:
    ...
    input_file_path = r"C:\Users\Camila\Downloads\BD-Proyecto2024\backend\postgreSQL\spotify_songs.csv"

    # Ruta para el nuevo archivo CSV con el tamaño especificado
    output_file_path = rf"C:\Users\Camila\Downloads\BD-Proyecto2024\backend\postgreSQL\spotify_songs_{i}.csv"
